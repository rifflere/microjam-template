...
namespace mj
{
    ...
    title_scene::title_scene(core &core) : _cursor_sprite(bn::sprite_items::mj_small_astro.create_sprite(0, 0, 12)),
    ...
    void title_scene::_update_menu()
    {
        ...
        else if (bn::keypad::a_pressed())
        {
            ...
            _cursor_sprite.set_tiles(bn::sprite_items::mj_small_astro.tiles_item(), 13);
